...
/**
 * This is the item provider adapter for a {@link com.fun.gantt.gantt.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GanttPackage.Literals.ACTIVITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_duration_feature", "_UI_Activity_type"),
				 GanttPackage.Literals.ACTIVITY__DURATION,
				 true,
				 false,
				 false,
	...
	protected void addIsMilestonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_isMilestone_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_isMilestone_feature", "_UI_Activity_type"),
				 GanttPackage.Literals.ACTIVITY__IS_MILESTONE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GanttPackage.Literals.ACTIVITY__DEPENDENCY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GanttPackage.Literals.ACTIVITY__DEPENDENCY,
				 GanttFactory.eINSTANCE.createDependency()));
	}
